...
### Question 1
medium.com web sitesinin Object modellemesini yapın. Aşağıdaki temel özelliklere sahip
olmalıdır. 
- Blog yayınlayabilmeli, silebilmeli, taslak oluşturabilmeli,
- Kullanıcıları takip etme,
- Kişilerin bloglarını listeleme
- Kullanıcıların tag’leri takip etmesi 


Projede uygulanması gerekenler:
- Katmanlı mimari kullanılmalı
- OOP prensipleri uygulanmalı
